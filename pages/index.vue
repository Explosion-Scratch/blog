		...
		<section>
			<div class="top_stuff flex justify-center items-center">
				<div class="right">
					...
					<center class="px-5">Your daily chunk of code content</center>
					<div style="z-index: 100;" class="sidebyside flex justify-center items-center flex-col sm:flex-row">
