			...
			<div class="top_stuff flex justify-center items-center">
				<div class="right">
					...
					<div class="sidebyside flex justify-center items-center flex-col sm:flex-row">
						<RippleButton @click="scrollToPosts" class="btn w-40 sm:w-auto">
