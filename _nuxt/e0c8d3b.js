                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                this.sortKeys &&
                                  ...
                                  (data = this.query.data({ removeMeta: !0 })),
                                  this.onlyKeys &&
                                    (this.options.watch &&
                ...
                set(e, t) {
                  if (null != t) {
                    ...
                    if (e in this._valMap)
                      throw new Error(
                        "Duplicate key for property $loki : " + e
                      );
              ...
              class v {
                ...
                simplesort(e, t = { desc: !1 }) {
                  if (
                    ...
                    let n = this._collection._rangedIndexes[
                        e
                      ].index.rangeRequest(),
                      r = [];
                ...
                find(e, t = !1) {
                  ...
                  if (this._collection._rangedIndexes[r]) {
                    if ("$in" === h) {
                      ...
                      for (let t of l) {
                        let n = e.index.rangeRequest({ op: "$eq", val: t });
                    ...
                    if ("$between" === h) {
                      let e = this._collection._rangedIndexes[
                        r
                      ].index.rangeRequest({ op: h, val: l[0], high: l[1] });
                ...
                eqJoin(e, t, n, r, o) {
                  ...
                  return (
                    (this._collection = new O("joinData")),
                ...
                map(e, t) {
                  ...
                  return (
                    (this._collection = new O("mappedData")),
              ...
              class y extends r.a {
                    ...
                    for (; e--; )
                      "where" === this._filterPipeline[e].type &&
                        (e !== this._filterPipeline.length - 1 &&
                          (this._filterPipeline[e] = this._filterPipeline[
                ...
                static fromJSONObject(e, t) {
                  ...
                  return (
                    ...
                    n._rematerialize({ removeWhereFilters: !0 }),
                    n
                  );
                }
                ...
                applySimpleSort(e, t = !1) {
                  return (
                    (this._sortCriteriaSimple = { field: e, options: t }),
                    (this._sortFunction = null),
                    (this._sortCriteria = null),
                    (this._sortByScoring = null),
                    this._queueSortPhase(),
                ...
                applyFind(e, t = "") {
                  return (
                    this.applyFilter({ type: "find", val: e, uid: t }), this
                  );
                }
                applyWhere(e, t) {
                  return (
                    this.applyFilter({ type: "where", val: e, uid: t }), this
                  );
                }
                removeFilter(e) {
                ...
                data(e = {}) {
                  return (
                    (this._sortDirty || this._resultDirty) &&
                      this._performSortPhase({ suppressRebuildEvent: !0 }),
                    this._persistent
                      ? this._resultData
              ...
              class O extends r.a {
                ...
                toJSON() {
                  return {
                    ...
                    defaultLokiOperatorPackage: this
                ...
                insertOne(e, t = !1) {
                  ...
                  if (
                    (this._disableMeta ||
                      void 0 !== o.meta ||
                      (o.meta = { version: 0, revision: 0, created: 0 }),
                ...
                _insertMeta(e) {
                  this._disableMeta ||
                    (e.meta ||
                      (e.meta = { version: 0, revision: 0, created: 0 }),
                ...
                startTransaction() {
                  if (this._transactional) {
                    let e = {};
                    for (let t in this._rangedIndexes)
                      (e[t].indexTypeName = this._rangedIndexes[
                        t
                      ].indexTypeName),
                        (e[t].comparatorName = this._rangedIndexes[
                          t
                        ].comparatorName),
            ...
            function (e, t, n) {
              ...
              (function (e) {
                ...
                class _ extends r.a {
                  ...
                  copy(e = {}) {
                    const t = new _(this.filename, { env: this._env });
                    if (
                      (t.loadJSONObject(this, { retainDirtyFlags: !0 }),
                  ...
                  serializeDestructured(e = {}) {
                    ...
                    const n = [];
                    n.push(t.serialize({ serializationMethod: "normal" })),
                      (t = null);
                    ...
                    return null === this._persistenceAdapter
                      ...
                      ? Promise.resolve(
                          this._persistenceAdapter.exportDatabase(
                            this.filename,
                            this.copy({ removeNonSerializable: !0 })
                          )
                        ).then(() => {
            ...
            function (e, t, n) {
              ...
              class f {
                ...
                insert(e, t) {
                  ...
                  if (0 == n.length)
                    return void this.docStore.set(t, { fieldLength: 0 });
                  (this.totalFieldLength += n.length),
                    (this.docCount += 1),
                    this.docStore.set(t, { fieldLength: n.length });
                  const r = [];
                    ...
                    if (
                      ...
                      for (let t = 0; t < n.length; t++) {
                        ...
                        if (((r.df -= 1), r.dc.delete(e), 0 === r.df)) {
                          if ((delete r.df, delete r.dc, 0 !== r.size))
                            continue;
                          do {
                            const e = r.pa;
                            delete r.pa;
                ...
                toJSON() {
                  return this._store
                    ...
                    : { _store: !1, _optimizeChanges: this._optimizeChanges };
                }
                static fromJSONObject(e, t) {
                  const n = new f({
                    store: e._store,
              ...
              class _ {
                  ...
                  for (const [e, l] of t) {
                    ...
                    for (let i = 0; i < l.length; i++) {
                      ...
                      if (void 0 !== n.tf) {
                        ...
                        (c = n.boost),
                          o && h.push({ boost: n.boost, score: c });
                      t += c;
                    }
                ...
                _getCache(e) {
                  if (void 0 === this._cache[e]) {
                    ...
                    this._cache[e] = { idfs: {}, avgFieldLength: t };
                  }
              ...
              class x {
                ...
                _finishCurrentState() {
                  ...
                  -1 !== p[0] &&
                    ...
                    (this._transitions[
                      this._currState
                    ] = this._stateTransitions.slice(0, e).sort(y)),
                    (this._stateTransitions = []);
                }
                getStartPoints() {
                  const e = new Set();
                  ...
                  switch (
                    ...
                    case "match": {
                      ...
                      if (
                        ...
                        for (let i = 0; i < l.length; i++)
                          f.push({ type: "term", field: o, value: l[i] });
