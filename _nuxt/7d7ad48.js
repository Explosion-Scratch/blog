(window.webpackJsonp = window.webpackJsonp || []).push([
  [0, 4, 5],
  {
    297: function (r, o, d) {
      ...
      (0, d(30).default)("0b577ddc", content, !0, { sourceMap: !1 });
    },
    298: function (r, o, d) {
      "use strict";
      d.r(o);
        ...
        B = !w(function () {
          ...
          if (!(f && f > 3)) {
            ...
            for (code = 65; code < 76; code++) {
              ...
              for (d = 0; d < 47; d++) y.push({ k: r + d, v: o });
            }
            for (
              y.sort(function (a, b) {
                return b.v - a.v;
              ...
              (r = y[d].k.charAt(0)), t.charAt(t.length - 1) !== r && (t += r);
            return "DGBEFHACIJK" !== t;
          }
        });
      t(
        { target: "Array", proto: !0, forced: C || !P || !A || !B },
        {
          sort: function (r) {
            void 0 !== r && x(r);
            var o = e(this);
            if (B) return void 0 === r ? _.call(o) : _.call(o, r);
            var d,
              t,
              w = [],
              c = n(o.length);
            for (t = 0; t < c; t++) t in o && w.push(o[t]);
            for (
              w = l(
                w,
                (function (r) {
    ...
    307: function (r, o) {
      var d = Math.floor,
        t = function (r, o) {
          var n = r.length,
            h = d(n / 2);
          return n < 8 ? x(r, o) : e(t(r.slice(0, h), o), t(r.slice(h), o), o);
        },
        x = function (r, o) {
          for (var element, d, t = r.length, i = 1; i < t; ) {
        ...
        e = function (r, o, d) {
          for (
            var t = r.length, x = o.length, e = 0, n = 0, h = [];
            e < t || n < x;

          )
            e < t && n < x
              ? h.push(d(r[e], o[n]) <= 0 ? r[e++] : o[n++])
              : h.push(e < t ? r[e++] : o[n++]);
          return h;
        };
      r.exports = t;
    ...
    308: function (r, o, d) {
      var t = d(61).match(/firefox\/(\d+)/i);
      r.exports = !!t && +t[1];
    },
    309: function (r, o, d) {
      var t = d(61);
      r.exports = /MSIE|Trident/.test(t);
    },
    310: function (r, o, d) {
      var t = d(61).match(/AppleWebKit\/(\d+)\./);
      r.exports = !!t && +t[1];
    },
    313: function (r, o, d) {
      "use strict";
      ...
      d(303), d(45);
      var t = {
          componets: { BlogPost: d(298).default },
          name: "BlogContainer",
          props: {
            items: {
              type: Array,
      ...
      o.default = component.exports;
      installComponents(component, { BlogPost: d(298).default });
    },
    321: function (r, o, d) {
      "use strict";
      var t = d(3),
        ...
        t(
          { target: "Array", proto: !0, forced: h },
          {
            findIndex: function (r) {
              return x(this, r, arguments.length > 1 ? arguments[1] : void 0);
            },
          }
        ),
        e(n);
    ...
    327: function (r, o, d) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[r.i, content, ""]]),
        content.locals && (r.exports = content.locals);
      (0, d(30).default)("5ca978f4", content, !0, { sourceMap: !1 });
    },
    338: function (r, o, d) {
      "use strict";
      d(327);
    ...
    339: function (r, o, d) {
      ...
      t.push([
        r.i,
        "[data-v-47898552]:export{dark:true}@-webkit-keyframes pulse-data-v-47898552{0%,to{opacity:1}50%{opacity:.5}}@keyframes pulse-data-v-47898552{0%,to{opacity:1}50%{opacity:.5}}@-webkit-keyframes shadowPulse-data-v-47898552{0%{filter:drop-shadow(4px 14px rgba(66,184,131,.2142857143)) drop-shadow(8px 7px rgba(66,184,131,.4285714286)) drop-shadow(4px 35px rgba(66,184,131,.0857142857)) drop-shadow(8px 44px rgba(66,184,131,.0681818182)) drop-shadow(4px 22px rgba(66,184,131,.1363636364))}10%{filter:drop-shadow(3px 9px rgba(66,184,131,.3333333333)) drop-shadow(4px 31px rgba(66,184,131,.0967741935)) drop-shadow(-8px 3px #42b883) drop-shadow(3px 19px rgba(66,184,131,.1578947368)) drop-shadow(5px 26px rgba(66,184,131,.1153846154))}20%{filter:drop-shadow(-3px 22px rgba(66,184,131,.1363636364)) drop-shadow(-4px 26px rgba(66,184,131,.1153846154)) drop-shadow(3px 1px #42b883) drop-shadow(2px 15px rgba(66,184,131,.2)) drop-shadow(9px 11px rgba(66,184,131,.2727272727))}30%{filter:drop-shadow(-9px 44px rgba(66,184,131,.0681818182)) drop-shadow(6px 37px rgba(66,184,131,.0810810811)) drop-shadow(3px 31px rgba(66,184,131,.0967741935)) drop-shadow(7px 4px rgba(66,184,131,.75)) drop-shadow(0 23px rgba(66,184,131,.1304347826))}40%{filter:drop-shadow(5px 7px rgba(66,184,131,.4285714286)) drop-shadow(4px 25px rgba(66,184,131,.12)) drop-shadow(-7px 22px rgba(66,184,131,.1363636364)) drop-shadow(5px 29px rgba(66,184,131,.1034482759)) drop-shadow(6px 13px rgba(66,184,131,.2307692308))}50%{filter:drop-shadow(0 20px rgba(66,184,131,.15)) drop-shadow(5px 33px rgba(66,184,131,.0909090909)) drop-shadow(8px 47px rgba(66,184,131,.0638297872)) drop-shadow(4px 27px rgba(66,184,131,.1111111111)) drop-shadow(-3px 29px rgba(66,184,131,.1034482759))}60%{filter:drop-shadow(9px 33px rgba(66,184,131,.0909090909)) drop-shadow(8px 38px rgba(66,184,131,.0789473684)) drop-shadow(3px 1px #42b883) drop-shadow(-7px 23px rgba(66,184,131,.1304347826)) drop-shadow(-3px 21px rgba(66,184,131,.1428571429))}70%{filter:drop-shadow(-6px 5px rgba(66,184,131,.6)) drop-shadow(3px 44px rgba(66,184,131,.0681818182)) drop-shadow(-5px 22px rgba(66,184,131,.1363636364)) drop-shadow(1px 24px rgba(66,184,131,.125)) drop-shadow(-1px 23px rgba(66,184,131,.1304347826))}80%{filter:drop-shadow(0 48px rgba(66,184,131,.0625)) drop-shadow(8px 43px rgba(66,184,131,.0697674419)) drop-shadow(-3px 48px rgba(66,184,131,.0625)) drop-shadow(2px 33px rgba(66,184,131,.0909090909)) drop-shadow(-3px 1px #42b883)}90%{filter:drop-shadow(5px 40px rgba(66,184,131,.075)) drop-shadow(6px 1px #42b883) drop-shadow(3px 36px rgba(66,184,131,.0833333333)) drop-shadow(-1px 35px rgba(66,184,131,.0857142857)) drop-shadow(9px 11px rgba(66,184,131,.2727272727))}to{filter:drop-shadow(-6px 47px rgba(66,184,131,.0638297872)) drop-shadow(-4px 7px rgba(66,184,131,.4285714286)) drop-shadow(-6px 48px rgba(66,184,131,.0625)) drop-shadow(-9px 7px rgba(66,184,131,.4285714286)) drop-shadow(-2px 13px rgba(66,184,131,.2307692308))}to{filter:drop-shadow(4px 14px rgba(66,184,131,.2142857143)) drop-shadow(8px 7px rgba(66,184,131,.4285714286)) drop-shadow(4px 35px rgba(66,184,131,.0857142857)) drop-shadow(8px 44px rgba(66,184,131,.0681818182)) drop-shadow(4px 22px rgba(66,184,131,.1363636364))}}@keyframes shadowPulse-data-v-47898552{0%{filter:drop-shadow(4px 14px rgba(66,184,131,.2142857143)) drop-shadow(8px 7px rgba(66,184,131,.4285714286)) drop-shadow(4px 35px rgba(66,184,131,.0857142857)) drop-shadow(8px 44px rgba(66,184,131,.0681818182)) drop-shadow(4px 22px rgba(66,184,131,.1363636364))}10%{filter:drop-shadow(3px 9px rgba(66,184,131,.3333333333)) drop-shadow(4px 31px rgba(66,184,131,.0967741935)) drop-shadow(-8px 3px #42b883) drop-shadow(3px 19px rgba(66,184,131,.1578947368)) drop-shadow(5px 26px rgba(66,184,131,.1153846154))}20%{filter:drop-shadow(-3px 22px rgba(66,184,131,.1363636364)) drop-shadow(-4px 26px rgba(66,184,131,.1153846154)) drop-shadow(3px 1px #42b883) drop-shadow(2px 15px rgba(66,184,131,.2)) drop-shadow(9px 11px rgba(66,184,131,.2727272727))}30%{filter:drop-shadow(-9px 44px rgba(66,184,131,.0681818182)) drop-shadow(6px 37px rgba(66,184,131,.0810810811)) drop-shadow(3px 31px rgba(66,184,131,.0967741935)) drop-shadow(7px 4px rgba(66,184,131,.75)) drop-shadow(0 23px rgba(66,184,131,.1304347826))}40%{filter:drop-shadow(5px 7px rgba(66,184,131,.4285714286)) drop-shadow(4px 25px rgba(66,184,131,.12)) drop-shadow(-7px 22px rgba(66,184,131,.1363636364)) drop-shadow(5px 29px rgba(66,184,131,.1034482759)) drop-shadow(6px 13px rgba(66,184,131,.2307692308))}50%{filter:drop-shadow(0 20px rgba(66,184,131,.15)) drop-shadow(5px 33px rgba(66,184,131,.0909090909)) drop-shadow(8px 47px rgba(66,184,131,.0638297872)) drop-shadow(4px 27px rgba(66,184,131,.1111111111)) drop-shadow(-3px 29px rgba(66,184,131,.1034482759))}60%{filter:drop-shadow(9px 33px rgba(66,184,131,.0909090909)) drop-shadow(8px 38px rgba(66,184,131,.0789473684)) drop-shadow(3px 1px #42b883) drop-shadow(-7px 23px rgba(66,184,131,.1304347826)) drop-shadow(-3px 21px rgba(66,184,131,.1428571429))}70%{filter:drop-shadow(-6px 5px rgba(66,184,131,.6)) drop-shadow(3px 44px rgba(66,184,131,.0681818182)) drop-shadow(-5px 22px rgba(66,184,131,.1363636364)) drop-shadow(1px 24px rgba(66,184,131,.125)) drop-shadow(-1px 23px rgba(66,184,131,.1304347826))}80%{filter:drop-shadow(0 48px rgba(66,184,131,.0625)) drop-shadow(8px 43px rgba(66,184,131,.0697674419)) drop-shadow(-3px 48px rgba(66,184,131,.0625)) drop-shadow(2px 33px rgba(66,184,131,.0909090909)) drop-shadow(-3px 1px #42b883)}90%{filter:drop-shadow(5px 40px rgba(66,184,131,.075)) drop-shadow(6px 1px #42b883) drop-shadow(3px 36px rgba(66,184,131,.0833333333)) drop-shadow(-1px 35px rgba(66,184,131,.0857142857)) drop-shadow(9px 11px rgba(66,184,131,.2727272727))}to{filter:drop-shadow(-6px 47px rgba(66,184,131,.0638297872)) drop-shadow(-4px 7px rgba(66,184,131,.4285714286)) drop-shadow(-6px 48px rgba(66,184,131,.0625)) drop-shadow(-9px 7px rgba(66,184,131,.4285714286)) drop-shadow(-2px 13px rgba(66,184,131,.2307692308))}to{filter:drop-shadow(4px 14px rgba(66,184,131,.2142857143)) drop-shadow(8px 7px rgba(66,184,131,.4285714286)) drop-shadow(4px 35px rgba(66,184,131,.0857142857)) drop-shadow(8px 44px rgba(66,184,131,.0681818182)) drop-shadow(4px 22px rgba(66,184,131,.1363636364))}}h2[data-v-47898552]{color:#516b8c;font-size:clamp(2rem,2.5vw,5rem);font-weight:900;padding-left:50px}",
        "",
      ]),
        (t.locals = {}),
        (r.exports = t);
      ...
      var t = d(91),
        x =
          ...
          d(321),
          {
            ...
            mounted: function () {
              var r = this.posts.sort(function (a, b) {
                var s = new Date(a.createdAt),
                  r = new Date(b.createdAt);
                return s.getTime() - r.getTime();
              });
              console.log({ sorted: r }), (this.p = r);
            },
            updated: function () {
              this.$el.querySelector(".err") &&
                Object(t.a)(this.$el.querySelectorAll(".err")).forEach(
                  function (span) {
                    return span.parentElement.setAttribute(
                      "disabled",
                      "disabled"
                    );
                  }
            ...
            methods: {
              slice: function (text, r) {
                return text.length >= r - 3
                  ? "".concat(text.slice(0, r - 3), "...")
                  : text;
              },
              idx: function (i, r) {
                return { front: r[i + 1], behind: r[i - 1] };
              },
            },
            computed: {
              postIndex: function () {
                var r = this;
                try {
                  return this.p.findIndex(function (i) {
                    return r.currentPost.path === i.path;
                  });
                } catch (r) {
        ...
        component = Object(e.a)(
          ...
          function () {
            ...
            return d(
              "div",
              { staticClass: "recentPosts w-full" },
              [
                d(
                  "div",
                  {
                    staticClass:
                      "buttons w-full px-[50px] flex mb-10 justify-between",
                  },
                  [
                    d(
                      "RippleButton",
                      {
                        staticClass:
                          "nextPost inline-flex items-center justify-center flex-row",
                      },
                      [
                        d(
                          "svg",
                        ...
                        r.nextPost
                          ? [
                              d(
                                "NuxtLink",
                                { attrs: { to: r.nextPost.path } },
                                [r._v(r._s(r.slice(r.nextPost.title, 30)))]
                              ),
                            ]
                          : [
                              d("span", { staticClass: "err" }, [
                                r._v("No post after this 🤷!"),
                              ]),
                            ],
                      ],
                      2
                    ...
                    d(
                      ...
                      {
                        staticClass:
                          "previousPost inline-flex items-center justify-center flex-row-reverse",
                      },
                      [
                        d(
                          "svg",
                        ...
                        r.previousPost
                          ? [
                              d(
                                "NuxtLink",
                                { attrs: { to: r.previousPost.path } },
                                [r._v(r._s(r.slice(r.previousPost.title, 30)))]
                              ),
                            ]
                          : [
                              d("span", { staticClass: "err" }, [
                                r._v("🎉 This is the first post!"),
                              ]),
                            ],
                      ],
                      2
                ...
                r._v(" "),
                d("h2", [r._v("Recent posts")]),
                r._v(" "),
                d("BlogContainer", {
                  staticClass: "posts w-full",
                  attrs: {
                    items: r.posts,
                    classes:
