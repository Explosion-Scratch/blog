<template>
    <header class="shown flex justify-between items-center p-3 dark:bg-white bg-gray-200 bg-opacity-10">
      ...
      <nav class="flex">
        <ul class="flex justify-center items-center">
          <li><a href="/">Home</a></li>
          <li><a href="mailto:explosionscratch@gmail.com">Contact</a></li>
        </ul>
      </nav>
    </header>
</template>
