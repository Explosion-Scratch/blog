<template>
    <div class="footer">
        <svg class="ripple" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <footer>
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <span class="ml-3 text-xl">--Explosion--</span>
                </a>
                ...
                <span class="text-green-100 inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                <NuxtLink to="/contact">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><g fill="none"><path d="M18 7.373V14.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 2 14.5V7.373l7.746 4.558a.5.5 0 0 0 .508 0L18 7.373zM15.5 4a2.5 2.5 0 0 1 2.485 2.223L10 10.92L2.015 6.223A2.5 2.5 0 0 1 4.5 4h11z" fill="currentColor"/></g></svg>
                </NuxtLink>
                <a class="ml-3" href="https://github.com/explosion-scratch">
...
.footer > svg {
    transform: scale(1, -0.5) translate(0, -52%);
    fill: $bg;
}
.footer {
    position: absolute;
...
.footer > svg {
	...
	display: block;
	margin: 0 auto;
	animation: shadowPulse 20s linear infinite;
}
</style>